 ...
 *   id = "vimeo_embed_tac_service",
 *   label = "Vimeo Embed",
 *   weight = 5
 * )
 */
class VimeoEmbedTacService implements TacServiceInterface {

  /**
   * Constant which stores the plugin ID.
   */
  const PLUGIN_ID = 'vimeo_embed_tac_service';

  /**
   * Constant which stores the library name.
   */
  const LIBRARY_NAME = 'tac_services/tac_vimeo_embed';
